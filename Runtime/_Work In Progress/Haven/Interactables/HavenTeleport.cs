...
#pragma warning restore 0649
        ...
        private void OnValidate()
        {
            ...
            if (this.interactionLayers != LayerMask.GetMask(HavenRig.TelportLayer))
            {
                this.interactionLayers = LayerMask.GetMask(HavenRig.TelportLayer);
            }

            if (this.teleportTrigger != TeleportTrigger.OnDeactivated)
            {
                this.teleportTrigger = TeleportTrigger.OnDeactivated;
            }
