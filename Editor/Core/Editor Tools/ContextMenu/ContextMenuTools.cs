...
namespace Lost
{
    ...
    {
        [MenuItem("Assets/Lost/Sub-Object/Add AnimationClip as Sub-Object", true, -101)]
        ...
        [MenuItem("Assets/Lost/Sub-Object/Add AnimationClip as Sub-Object", false, -101)]
        ...
        [MenuItem("Assets/Lost/Sub-Object/Add Show And Hide Sub-Object Animations", true, -102)]
        public static bool AddChildAnimationClipValidator()
        {
            return Selection.activeObject is AnimatorController;
        }

        [MenuItem("Assets/Lost/Sub-Object/Add Show And Hide Sub-Object Animations", false, -102)]
        ...
        [MenuItem("Assets/Lost/Sub-Object/Add TextObject as Sub-Object", true, -103)]
        ...
        [MenuItem("Assets/Lost/Sub-Object/Add TextObject as Sub-Object", false, -103)]
        ...
        [MenuItem("Assets/Lost/Sub-Object/Delete Sub-Object", true, -104)]
        ...
        [MenuItem("Assets/Lost/Sub-Object/Delete Sub-Object", false, -104)]
